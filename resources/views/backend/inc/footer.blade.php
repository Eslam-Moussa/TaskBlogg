...
<script src="{{url('/')}}/back/assets/node_modules/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
<!--morris JavaScript -->
<script src="{{url('/')}}/back/assets/node_modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
<script type="text/javascript" src="{{url('/')}}/back/assets/node_modules/multiselect/js/jquery.multi-select.js"></script>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        $('#mytext').fontIconPicker({
            source: ['icon-heart', 'icon-search', 'icon-user', 'icon-tag', 'icon-help','icon-thumbs-up-alt','icon-left-dir','icon-up-dir','icon-down-dir','icon-volume-down',
            'icon-wrench','icon-cog','icon-phone-squared','icon-upload-cloud','icon-thumbs-down-alt','icon-bookmark','icon-eye','icon-info-circled','icon-help-circled',
            'icon-cancel','icon-star','icon-right-dir','icon-home','icon-doc',' icon-coffee','icon-windows','icon-bitbucket','icon-youtube','icon-android','icon-male','icon-skype',
        'icon-book','icon-desktop','icon-food','icon-flag','icon-gift','icon-moon','icon-laptop','icon-key','icon-plane','icon-signal','icon-umbrella','icon-truck','icon-hospital','icon-apple','icon-suitcase','icon-money','icon-lightbulb','icon-fire',
